...
class FollowingProject extends Component {
    render() {
        ...
        return(
            <div className={`col-12 col-md-${colMd} p-0 text-center ${followingProjectClassName} ${textAlignClassName}`}>
                <Link to={url} className="card d-flex flex-row work-link">
                    <div className="cover-image img-fluid" style={{backgroundImage: `url(/public/${coverImage})`}}></div>
                    ...
                    <div className="wrapper d-flex flex-row align-self-center p-3">
                        <div className="content">
                            <h4 className="text d-inline-block font-weight-normal m-0">
                                <small className="d-block title text-capitalize text-white mt-0 mb-1">{title}</small>
