				...
				<div id="about" className="container pr-sm-0 pl-sm-0 pt-12 pb-12">
		    		<div className="row align-items-center">
		    			...
		    			<section className="section col-12 col-lg-6 pl-5">
		    				...
		    				<p className="mb-0">A 19-year-old prodigy, combining design and front-end skills, volunteering in different causes and a great team-player, who will never leave you on your own. Extremely diligent, life-time learner, with the intention to become a front-end grand master.</p>
		    			</section>
		    		</div>
		    	</div>
			</div>
